    ...
    <section id="about-me" className="about-me">
      ...
      <nav className="about-me__portfolio">
        ...
        <ul className="portfolio__links">
          <li className="portfolio__item"><a className="portfolio__link link" href="#">Статичный сайт<img className="portfolio__link-image" src={diagonalArrow} alt="Перейти"/></a></li>
          <li className="portfolio__item"><a className="portfolio__link link" href="#">Адаптивный сайт<img className="portfolio__link-image" src={diagonalArrow} alt="Перейти"/></a></li>
          <li className="portfolio__item"><a className="portfolio__link link" href="#">Одностраничное приложение<img className="portfolio__link-image" src={diagonalArrow} alt="Перейти"/></a></li>
        </ul>
      </nav>
    </section>
  );
